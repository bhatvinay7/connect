...
export default function AtrtsClub(){
  ...
  const [clubName,setClubName]=useState("Arts Club")
  ...
  return(
    ...
    <div className='relative  top-20 md:top-24 min-h-screen  w-full  '>
      <div className='relative w-full h-auto bg-artsClubImg bg-repeat-x bg-center bg-opacity-60 bg-cover '>
        {/* Add a light overlay */}
        ...
        <div className='relative w-full h-auto flex flex-row justify-between items-center z-10'>
            ...
            <div className=' relative z-20 w-fit mx-auto mb-4 p-2   flex caret-transparent select-none rounded-lg justify-center flex-col items-center h-40 shadow-sm shadow-white/15 '>
              <div className='text-black  font-bold text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl'>ARTS CLUB</div>
              <div className='text-yellow-300 text-[8px] sm:text-xs md:text-base mt-2'>Art Beyond Boundaries</div>
            </div>
        </div>
      </div>
      <div ref={recentEvent} className='bg-blue-500/60'>
