...
import myaxios from '../fetch/axios.js'; 
  ...
  // const []
   function handleLogin(e){
    ...
    const responseGoole=async (authResult)=>{
      try{
           if(authResult['code']){
            const response= await myaxios.get(`/api/googleLogin?code=${encodeURIComponent(authResult.code)}`,{headers:{"Content-Type":'application/json'},withCredentials:true})
