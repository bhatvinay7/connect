        ...
        <div className="w-full m-auto mx-4 box-border shadow-2xl bg-slate-500 rounded sm:px-4  md: p-8 md:max-w-2xl 2xl:w-2/5">
          ...
          <div className=" flex flex-col justify-center items-center w-full">
            <Form className="flex flex-col justify-center items-center w-full" method="post" >
              ...
              <button className="text-base sm:text-base w-1/2  p-3 rounded mb-5 mt-3 hover:ring ring-teal-500 ring-offset-2 bg-violet-400 hover:bg-gray-400 hover:rounded-md sm:w-1/4  md:w-3/12 " >Sign In</button>
            </Form>
